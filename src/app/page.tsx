  ...
  return (
    <div className="flex flex-col gap-10 pb-8 sm:gap-12">
      ...
      <Link
        ...
        className="group flex flex-col gap-5 rounded-2xl border border-accent/30 bg-card px-6 py-5 transition-colors hover:border-accent sm:flex-row sm:items-center sm:px-8"
      >
